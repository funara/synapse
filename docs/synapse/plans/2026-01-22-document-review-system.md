...
> **For agentic workers:** REQUIRED: Use synapse:build to implement this plan.
...
**Spec:** docs/synapse/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/synapse/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use synapse:build to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
