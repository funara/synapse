...
> **For agentic workers:** REQUIRED: Use synapse:build to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**Spec:** `docs/synapse/specs/2026-03-11-zero-dep-brainstorm-server-design.md`
...
- **Create:** `skills/spec/scripts/server.js` - the zero-dep replacement
- **Modify:** `skills/spec/scripts/start-server.sh:94,100` - change `index.js` to `server.js`
- **Modify:** `.gitignore:6` - remove the `!skills/spec/scripts/node_modules/` exception
- **Delete:** `skills/spec/scripts/index.js`
- **Delete:** `skills/spec/scripts/package.json`
- **Delete:** `skills/spec/scripts/package-lock.json`
- **Delete:** `skills/spec/scripts/node_modules/` (714 files)
- **No changes:** `skills/spec/scripts/helper.js`, `skills/spec/scripts/frame-template.html`, `skills/spec/scripts/stop-server.sh`
...
**Files:**
- Create: `skills/spec/scripts/server.js`
...
```bash
git add skills/spec/scripts/server.js
...
**Files:**
- Modify: `skills/spec/scripts/server.js`
...
**Files:**
- Modify: `skills/spec/scripts/start-server.sh:94,100`
- Modify: `.gitignore:6`
- Delete: `skills/spec/scripts/index.js`
- Delete: `skills/spec/scripts/package.json`
- Delete: `skills/spec/scripts/package-lock.json`
- Delete: `skills/spec/scripts/node_modules/` (entire directory)
...
In `.gitignore`, delete line 6: `!skills/spec/scripts/node_modules/`

- [ ] **Step 3: Delete old files**

```bash
git rm skills/spec/scripts/index.js
git rm skills/spec/scripts/package.json
git rm skills/spec/scripts/package-lock.json
git rm -r skills/spec/scripts/node_modules/
```
...
```bash
git add skills/spec/scripts/ .gitignore
