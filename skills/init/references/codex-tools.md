...
Claude Code skills reference named agent types like `synapse:code-reviewer`.
...
|-------------------|------------------|
| `Task tool (synapse:code-reviewer)` | `spawn_agent(agent_type="worker", message=...)` with `code-reviewer.md` content |
